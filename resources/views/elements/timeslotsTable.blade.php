...
<div class="table-responsive">
    ...
    <table id="data_table" class="table table-bordered table-striped table-hover">
        ...
        <tr>
            ...
            <th>{{$lang->get(639)}}</th> {{--From--}}
            <th>{{$lang->get(640)}}</th> {{--To--}}
...
<script>
    ...
    function initTableHeader(){
        var html = `
            ...
            <th>{{$lang->get(639)}} <img onclick="tableHeaderSort('from');" src="${utilGetImg('from')}" class="img-fluid" style="margin-left: 10px; width: 20px; float: right;"></th> {{--From--}}
            <th>{{$lang->get(640)}} <img onclick="tableHeaderSort('to');" src="${utilGetImg('to')}" class="img-fluid" style="margin-left: 10px; width: 20px; float: right;"></th> {{--To--}}
