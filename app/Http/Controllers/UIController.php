...
class UIController extends Controller
{
    ...
    public function caTheme(Request $request)
    {
        ...
        return view('caTheme', [
            ...
            'deliveringDate' => DB::table('settings')->where('param', '=', "deliveringDate")->get()->first()->value,
    ...
    public function caLayout_changeTheme(Request $request)
    {
        ...
        DB::table('settings')->where('param', '=', "deliveringDate")->update(['value' => $request->input('deliveringDate'), 'updated_at' => new \DateTime(),]);
        //
